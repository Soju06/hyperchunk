...
static const char *const g_names[HC_CTR_N] = {
    ...
    [HC_CTR_X8_SLICE] = "x8_slice",
    [HC_CTR_X8_CELL] = "x8_cell",
    [HC_CTR_X8_NODE] = "x8_node",
    [HC_CTR_X8_PERLIN] = "x8_perlin",
    [HC_CTR_X8_SCALAR_FB] = "x8_scalar_fb",
    [HC_CTR_X8_RC_MIX] = "x8_rc_mix",
    [HC_CTR_X8_IS_MIX] = "x8_is_mix",
    [HC_CTR_X8_BLEND_MIX] = "x8_blend_mix",
    [HC_CTR_X8_DUAL] = "x8_dual",
    [HC_CTR_X8_PERLIN2] = "x8_perlin2",
